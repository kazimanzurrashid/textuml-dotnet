define(function(require) {
  ...
  return describe('views/documentlist', function() {
    ...
    view = null;
    before(function() {
      fixtures.set('<div id="document-list">' + '<div class="btn-toolbar">' + '<a class="btn" data-sort-attribute="title">title</a>' + '<a class="btn" data-sort-order="0">ascending</a>' + '</div>' + '<div class="list-container">' + '<ul></ul>' + '</div>' + '<script id="document-item-template" type="text/html">' + '<%= title %>' + '</script>' + '<script id="document-edit-item-template" type="text/html">' + '<%= title %>' + '</script>' + '</div>');
